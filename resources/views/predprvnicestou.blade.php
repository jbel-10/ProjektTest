...
<body class="font-serif min-h-screen flex flex-col">
 ...
 <!-- Hlavni sekce -->
<main class="w-full h-[60vh] bg-cover bg-center bg-no-repeat" style="background-image: url('/obrazky/predprvnicestou.jpg');">

  <!-- Navigace -->
  <nav class="top-0 w-full flex justify-center py-6 z-10">
    <ul class="flex space-x-10 text-white text-xl font-medium">
      ...
      <li class="relative group">
        ...
        <ul class="hidden group-hover:block bg-blue text-white p-4 rounded shadow-lg space-y-2 min-w-[100px]">
